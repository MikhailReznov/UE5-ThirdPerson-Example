...
"C:\Program Files\Epic Games\UE_5.0\Engine\Build\BatchFiles\RunUAT.bat" BuildPlugin -Rocket -Plugin=%~dp0Plugins\glTFRuntime\glTFRuntime.uplugin -TargetPlatforms=Win64 -Package=%~dp0..\glTFRuntime
